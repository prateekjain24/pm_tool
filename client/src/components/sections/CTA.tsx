        ...
        <div className="relative bg-gradient-to-br from-background via-background to-muted/20 rounded-3xl border border-border/50 shadow-2xl p-8 md:p-12 lg:p-16">
          ...
          <div className="relative z-10 text-center">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              <span className="bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(to right, var(--gradient-dark), var(--gradient-medium))' }}>
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Join <span className="text-primary font-semibold">500+ product teams</span> who've increased their experiment success rate by 25%.
            </p>
              ...
              {benefits.map((benefit, index) => {
                ...
                return (
                  ...
                  >
                    <div className={cn(
                      "p-2 rounded-lg",
                      benefit.color === "blue" && "bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400",
                      benefit.color === "green" && "bg-green-100 dark:bg-green-900/20 text-green-600 dark:text-green-400",
                      benefit.color === "purple" && "bg-purple-100 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400",
                      benefit.color === "emerald" && "bg-emerald-100 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400"
                    )}>
